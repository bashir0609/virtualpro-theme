...
<footer id="colophon" class="bg-gray-900 text-gray-300">
		...
		<div class="py-12 md:py-16">
			<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
				...
				<?php if ( has_nav_menu( 'menu-2' ) ) : ?>
					<div>
						<h4 class="text-white font-semibold text-lg mb-4"><?php esc_html_e( 'Quick Links', 'virtualpro' ); ?></h4>
						<nav aria-label="<?php esc_attr_e( 'Footer Menu', 'virtualpro' ); ?>">
							<?php
							wp_nav_menu(
								array(
				...
				<?php if ( is_active_sidebar( 'sidebar-1' ) ) : ?>
					<div>
						<aside role="complementary" aria-label="<?php esc_attr_e( 'Footer', 'virtualpro' ); ?>">
		...
		<div class="border-t border-gray-800 py-6">
			<div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
				<div class="text-sm text-gray-400">
					<?php
					$virtualpro_blog_info = get_bloginfo( 'name' );
					if ( ! empty( $virtualpro_blog_info ) ) :
						?>
						&copy; <?php echo esc_html( date_i18n( __( 'Y', 'virtualpro' ) ) ); ?> 
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" class="hover:text-white transition-colors">
							<?php bloginfo( 'name' ); ?>
						</a>. 
						<?php esc_html_e( 'All rights reserved.', 'virtualpro' ); ?>
						<?php
					endif;
					?>
				</div>
				...
				<div class="flex items-center space-x-6 text-sm text-gray-400">
					<a href="<?php echo esc_url( home_url( '/privacy-policy' ) ); ?>" class="hover:text-white transition-colors">
						<?php esc_html_e( 'Privacy Policy', 'virtualpro' ); ?>
					</a>
					<a href="<?php echo esc_url( home_url( '/terms' ) ); ?>" class="hover:text-white transition-colors">
						<?php esc_html_e( 'Terms of Service', 'virtualpro' ); ?>
					</a>
					...
					<span>
						...
						printf(
							esc_html__( 'Powered by %s', 'virtualpro' ),
